...
//created function to take req.query argument in app.get function
...
//second callback function that will execute everytime route is accessed with a GET request
...
app.post('/api/animals', (req, res) => {
  ...
  if (!validateAnimal(req.body)) {
    ...
    // add animla to json file and animals array in this function 
